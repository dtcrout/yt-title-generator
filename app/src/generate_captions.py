...
def generate_title(model, tokenizer, photo, max_length):
    ...
    Given a sequence of words and photo, we pick the next word randomly from
    all probably words. We also don't consider repeated words.
    ...
    -------
    in_text: str
      Generated caption for thumbnail.
    """
    in_text = "startseq"
